...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
  ...
  (0, _hooks.usePropsValidator)(props);
  //#endregion
  ...
  const animatedHandleHeight = (0, _hooks.useReactiveSharedValue)(_providedHandleHeight ?? _constants2.INITIAL_HANDLE_HEIGHT);
  ...
  }, [_providedContainerHeight, _providedHandleHeight, animatedContainerHeight, animatedHandleHeight, animatedSnapPoints, handleComponent]);
  ...
  }, [animatedAnimationState, animatedKeyboardState, animatedScrollableOverrideState, animatedSheetState]);
  // dynamic
  ...
  const animateToPosition = (0, _reactNativeReanimated.useWorkletCallback)(function animateToPosition(position, source) {
    let velocity = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    let configs = arguments.length > 3 ? arguments[3] : undefined;
  ...
  }, [_providedContentHeight, animatedContentHeight, _providedAnimationConfigs]);
