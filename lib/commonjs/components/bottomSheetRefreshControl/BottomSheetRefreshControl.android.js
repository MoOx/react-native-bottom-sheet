...
function BottomSheetRefreshControlComponent(_ref) {
  let {
    onRefresh,
    scrollableGesture,
    ...rest
  ...
  const gesture = (0, _react.useMemo)(() => _reactNativeGestureHandler.Gesture.Simultaneous(_reactNativeGestureHandler.Gesture.Native().shouldCancelWhenOutside(false), scrollableGesture, draggableGesture), [draggableGesture, scrollableGesture]); //#endregion
  // render
