...
const BottomSheetModalComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheetModal(props, ref) {
  ...
  const handleSnapToIndex = (0, _react.useCallback)(function () {
  ...
  const handleSnapToPosition = (0, _react.useCallback)(function () {
  ...
  const handleExpand = (0, _react.useCallback)(function () {
  ...
  const handleCollapse = (0, _react.useCallback)(function () {
  ...
  const handleClose = (0, _react.useCallback)(function () {
  ...
  const handleForceClose = (0, _react.useCallback)(function () {
