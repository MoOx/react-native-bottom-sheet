...
const useScrollHandler = () => {
  //#region refs
  const scrollableRef = (0, _react.useRef)(); //#endregion
  //#region variables

  const scrollableContentOffsetY = (0, _reactNativeReanimated.useSharedValue)(0); //#endregion
  //#region hooks
  ...
  }, [animatedAnimationState, animatedScrollableContentOffsetY, animatedScrollableState, scrollableContentOffsetY]); //#endregion
