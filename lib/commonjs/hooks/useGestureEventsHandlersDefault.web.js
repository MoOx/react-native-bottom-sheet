...
const useGestureEventsHandlersDefault = () => {
  ...
  const context = (0, _reactNativeReanimated.useSharedValue)({ ...INITIAL_CONTEXT
  }); //#endregion
  //#region gesture methods

  const handleOnStart = (0, _reactNativeReanimated.useWorkletCallback)(function handleOnStart(__, _ref) {
    let {
      translationY
    } = _ref;
  ...
  const handleOnChange = (0, _reactNativeReanimated.useWorkletCallback)(function handleOnChange(source, _ref2) {
    let {
      translationY
    } = _ref2;
  ...
  const handleOnEnd = (0, _reactNativeReanimated.useWorkletCallback)(function handleOnEnd(source, _ref3) {
    let {
      translationY,
      absoluteY,
      velocityY
