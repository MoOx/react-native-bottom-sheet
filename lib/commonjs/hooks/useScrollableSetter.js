...
const useScrollableSetter = function (ref, type, contentOffsetY, refreshable) {
  let useFocusHook = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _react.useEffect;
  // hooks
  const {
