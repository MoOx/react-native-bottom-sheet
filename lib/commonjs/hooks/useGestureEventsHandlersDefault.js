...
const useGestureEventsHandlersDefault = () => {
  ...
  const handleOnChange = (0, _reactNativeReanimated.useWorkletCallback)(function handleOnChange(source, _ref) {
    let {
      translationY
    } = _ref;
  ...
  const handleOnEnd = (0, _reactNativeReanimated.useWorkletCallback)(function handleOnEnd(source, _ref2) {
    let {
      translationY,
      absoluteY,
      velocityY
