...
export const useScrollable = () => {
  ...
  const setScrollableRef = useCallback(ref => {
    ...
    let currentRefId = ((_scrollableRef$curren = scrollableRef.current) === null || _scrollableRef$curren === void 0 ? void 0 : _scrollableRef$curren.id) ?? null;
  ...
  const removeScrollableRef = useCallback(ref => {
    ...
    let currentRefId = ((_scrollableRef$curren2 = scrollableRef.current) === null || _scrollableRef$curren2 === void 0 ? void 0 : _scrollableRef$curren2.id) ?? null;
    /**
     * @DEV
