...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY) => {
  ...
  const handleOnBeginDrag = useWorkletCallback((_ref, context) => {
    let {
      contentOffset: {
        y
      }
  ...
  const handleOnEndDrag = useWorkletCallback((_ref2, context) => {
    let {
      contentOffset: {
        y
      }
  ...
  const handleOnMomentumEnd = useWorkletCallback((_ref3, context) => {
    let {
      contentOffset: {
        y
      }
