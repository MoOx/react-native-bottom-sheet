...
function BottomSheetRefreshControlComponent(_ref) {
  ...
  const gesture = useMemo(() => Gesture.Simultaneous(Gesture.Native().shouldCancelWhenOutside(false), scrollableGesture, draggableGesture), [draggableGesture, scrollableGesture]); //#endregion
  // render
